...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: `Booking ${bookingCode} - Fasticket`,
        ...
        <Card className="mt-6 bg-muted/50">
          <CardContent className="pt-6">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
              <li>Please save your booking code: <strong className="font-mono">{booking.booking_code}</strong></li>
              <li>Show this code at the event entrance</li>
              <li>You can view your booking anytime from "My Bookings"</li>
